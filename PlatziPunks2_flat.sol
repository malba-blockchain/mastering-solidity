...
// File: contracts/Curso de DApps/PlatziPunksADN.sol
...
contract PlatziPunksADN {
    ...
    // TODO: Calculate DNA.
    //Una función pura no lee ni escribe parámetros en la blockchain, solo procesa datos y generan un resultado.
    //Estas no cuestan gas
    //Las direcciones suelen tener el mismo tamaño 160 caracteres
        ...
        returns (uint256)
    {
        ...
        //Convierte el entero a un dato en byes
        bytes memory encodedParams = abi.encodePacked(combinedParams);
        
        //Toma la entrada y genera la salida del hash
    ...
    //Función para hacer toda la operación sobre el cálculo del DNA
    ...
    function getAccessoriesType (uint256 _dna) public view returns (string memory) {
        ...
        //Asegúrate de obtener un valor de indice valido aunque la pieza de ADN sea muy grande o pequeña
...
// File: contracts/Curso de DApps/PlatziPunks2.sol
